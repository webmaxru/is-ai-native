...
7. If scanner behavior changes, run the smallest relevant test scope, starting with `packages/core/tests` and extending to `webapp/backend/tests/unit` only when the change crosses that boundary.
